...
/* Private defines -----------------------------------------------------------*/
#define IR_P5_Pin GPIO_PIN_0
#define IR_P5_GPIO_Port GPIOC
#define LCD_RST_Pin GPIO_PIN_1
#define LCD_RST_GPIO_Port GPIOC
#define IR_P6_Pin GPIO_PIN_2
#define IR_P6_GPIO_Port GPIOC
#define IR_P7_Pin GPIO_PIN_3
#define IR_P7_GPIO_Port GPIOC
...
#define IR_P8_Pin GPIO_PIN_5
#define IR_P8_GPIO_Port GPIOC
